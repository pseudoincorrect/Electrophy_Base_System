...
#define AUDIO_PACKET_SIZE(size)			         (uint8_t)(size & 0xFF), (uint8_t) ((size >> 8) & 0xFF)

//#define AUDIO_PACKET_SZE(frq)  (uint8_t) ((8*frq/1000) & 0xFF), \
//(uint8_t)(((8*frq/1000) >> 8) & 0xFF)

/*
#define AUDIO_PACKET_SZE(frq)          (uint8_t)(((frq * 1 * 8)/1000) & 0xFF), \
                                       (uint8_t)((((frq * 1 * 8)/1000) >> 8) & 0xFF)
*/
...
__ALIGN_BEGIN static uint8_t USBD_AUDIO_CfgDesc[USB_AUDIO_CONFIG_DESC_SIZ] __ALIGN_END =
{
 ...
 /*USB Microphone Output Terminal Descriptor */
  ...
  AUDIO_PACKET_SIZE(512),								// wMaxPacketSize 
	0x01,                                 /* bInterval */
  0x00,                                 /* bRefresh */
  0x00,                                 /* bSynchAddress */
  /* 09 byte*/
...
static uint8_t  USBD_AUDIO_DataIn (USBD_HandleTypeDef *pdev, uint8_t epnum)
{		
	while (ElectrophyData_Checkfill_USB() <= 0){;}
